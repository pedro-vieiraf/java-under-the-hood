# Chapter 02 - JVM Startup and Class Loading Internals
...
```bash
javac com/pedrovieira/javaunderhood/chapters/chapter02/startup/bytecode/BytecodeExample.java
```
...
### Location
```
src/main/java/com/pedrovieira/javaunderhood/chapters/chapter02/startup/classloading
```
